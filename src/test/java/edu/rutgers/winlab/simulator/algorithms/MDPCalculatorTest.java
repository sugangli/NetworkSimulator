...
import edu.rutgers.winlab.simulator.gaming.common.SimulationRunner;
 ...
 * @author ubuntu
 */
public class MDPCalculatorTest {

    public MDPCalculatorTest() {
    }
    ...
    private double _calculateReward(Node prevServer, Node nextServer, Node nextClient) {
    ...
    private MyNode _center;
    private final double MIGTATE_COST = 0;

    private double[] _createMoveProbabilityCircle(int locationCount) {
    ...
    public void _printProbabilities(double[] probabilities, PrintStream ps) {
...
//        _printProbabilities(probabilities, System.out);
        ...
        MDPCalculator c = new MDPCalculator(_serverLocations, _clientLocations, probabilities, this::_calculateReward, sigma);
        System.out.println("Calculating rewards...");
        long prev = System.nanoTime();
        c.calculateRewards();
        long after = System.nanoTime();
        System.out.printf("Finished in %f s%n", (after - prev) / 1000000000.0);
